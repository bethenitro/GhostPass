  ...
  return (
    <>
      <motion.div
        ...
        className={cn(
          "fixed top-44 right-4 sm:top-48 md:top-6 md:right-6 z-40 bg-slate-900/95 backdrop-blur-xl border rounded-xl shadow-2xl",
          "w-[180px] sm:w-[200px] md:w-auto md:max-w-[240px]",
      ...
      >
        <div className="p-2 sm:p-3 md:p-4">
          ...
          <div className="flex items-center justify-between mb-1 sm:mb-2">
            ...
            <div className={cn(
              "px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-full text-xs font-medium border",
              isSessionExpiringSoon
          ...
          {/* Session Type */}
          <div className="text-xs text-slate-400 mb-2 sm:mb-3">
          ...
          <motion.button
            ...
            className={cn(
              "w-full flex items-center justify-center space-x-1 sm:space-x-2 py-1.5 sm:py-2 px-2 sm:px-3 rounded-lg font-medium transition-all duration-300 border",
              isSessionExpiringSoon
          ...
          >
            ...
            <span className="text-xs sm:text-sm">SHOW QR</span>
          </motion.button>
          ...
          {isSessionExpiringSoon && (
            <motion.div
              ...
              className="mt-1.5 sm:mt-2 text-xs text-red-400 text-center"
            >
              ⚠️ Vaporizing soon!
            </motion.div>
          )}
        ...
        {showQRModal && (
          ...
          >
            <motion.div
              ...
              className={cn(
                "bg-slate-900 border rounded-xl shadow-2xl w-full max-w-sm mx-4 p-4 sm:p-6",
                isSessionExpiringSoon 
